...
export const RULES: Rule[] = [
  {
    ...
    "footnote": "Flipping the switch off is reversible; the memories are not. Everyone who does it has to live afterwards with what they did while it was off — which is the engine of at least four major arcs."
  },
  {
    ...
    "footnote": "Every werewolf character is introduced with a body already behind them. Tyler causes a car crash; Mason kills a man in a fight; Rafael repeats Tyler’s exactly. The show never lets you forget what the trigger is."
  },
  {
    "id": "how-magic-works",
    ...
    "footnote": "A siphoner who becomes a vampire is a Heretic: a magic-using vampire with an infinite internal battery. That is the one combination the Gemini coven built prison worlds to prevent."
  },
  {
    "id": "how-death-works",
    ...
    "footnote": "Humans always found peace. The Other Side only ever filed the supernatural — which is why the franchise’s body count was reversible for five seasons and permanent afterwards."
  },
  {
    ...
    "footnote": "The dagger trick does not work on Klaus, because he is half werewolf. This is the whole reason his siblings could be stored in boxes and he could not."
  },
  {
    ...
    "footnote": "An Original can compel any vampire. That single asymmetry is where most of the leverage in seasons three and four comes from."
  },
  {
    ...
    "footnote": "Route of the cure: buried with Silas → forced on Katherine → Silas → Amara → a second dose out of the 1994 prison world → Elena → Stefan → Damon."
  },
  {
    ...
    "footnote": "Nearly every protagonist is in Klaus’s line, which is the structural reason he survives eight seasons of people wanting him dead."
  }
]
