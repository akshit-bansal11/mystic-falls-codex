...
export const PEOPLE: Person[] = [
  ...
  },
  {
    ...
    facts: ['"Always and forever" was sworn over his body.'],
    connections: [
      {
        id: 'klaus',
  ...
  },
  {
    ...
    category: 'vamp',
    oneLine:
      'Klaus’s son in everything but blood, and the only man who ever took the city off him.',
    biography: [
  ...
  },
  {
    ...
    facts: ['Her death is the only time Katherine Pierce is uncomplicatedly sincere on screen.'],
    connections: [
      {
        id: 'katherine',
        relation: 'daughter',
  ...
  },
  {
    ...
    facts: ['He told his sons their mother had died of consumption. She had not.'],
    connections: [
      {
        id: 'stefan',
        relation: 'killed by',
  ...
  },
  {
    ...
    facts: ['He is defeated only when Lily finally accepts what he is, which kills her too.'],
    connections: [
      {
        id: 'lily',
        relation: 'loved by',
  ...
  },
  {
    ...
    facts: ["Her death is the show's first statement that turning is not a gift."],
    connections: [
      {
        id: 'matt',
        relation: 'sister',
  ...
  },
  {
    ...
    facts: ['His death is what teaches the town that a werewolf bite kills vampires.'],
    connections: [
      {
        id: 'tyler',
        relation: 'uncle',
  ...
  },
  {
    ...
    facts: ['The Lockwood family secret survived generations by simply never being discussed.'],
    connections: [
      {
        id: 'tyler',
        relation: 'mother',
  ...
  },
  {
    ...
    facts: ["The tomb vampires' release is what turns the first season's mystery into a war."],
    connections: [
      {
        id: 'anna',
        relation: 'mother',
  ...
  },
  {
    ...
    facts: ['He is where the silver-dagger-and-white-oak-ash method comes from.'],
    connections: [
      {
        id: 'rebekah',
        relation: 'betrayed',
  ...
  },
  {
    ...
    facts: ["He is the show's clearest statement that tradition and love are not the same thing."],
    connections: [
      {
        id: 'kai',
        relation: 'father',
  ...
  },
  {
    ...
    facts: ['She and Mary Louise die together, which is the point.'],
    connections: [
      {
        id: 'marylouise',
        relation: 'partner',
  ...
  },
  {
    ...
    facts: ['His silence makes him the only Heretic nobody manages to manipulate.'],
    connections: [
      {
        id: 'lily',
        relation: 'turned by',
  ...
  },
  {
    ...
    facts: ["She is Davina's opposite: same ritual, same power, entirely different conclusion."],
    connections: [
      {
        id: 'davina',
        relation: 'Harvest sister',
  ...
  },
  {
    ...
    facts: ['He is the Matt Donovan role for the next generation, which the show acknowledges.'],
    connections: [
      {
        id: 'lizzie',
        relation: 'friend',
