...
export const CAUSAL_MAP: CausalNode[] = [
  {
    ...
    category: 'origin',
    summary:
      "Silas, a warlock of the ancient world, and Qetsiyah, the strongest witch of her age, were betrothed — and together they made the first immortality elixir. Silas drank it with her handmaiden Amara instead. Every supernatural thing that follows for two thousand years is Qetsiyah's revenge for that afternoon.",
    facts: [
    ...
    peopleInvolved: ['silas', 'qetsiyah', 'amara'],
    leadsTo: [
      {
        node: 'amara',
        relation: 'loved',
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      'The handmaiden Silas chose. Qetsiyah did not kill her — she did something worse. Amara was made the Anchor to the Other Side: awake, immortal, and used as the doorway through which every supernatural death passed for two thousand years. Silas spent all of it believing she was simply dead.',
    facts: [
    ...
    peopleInvolved: ['amara', 'silas', 'qetsiyah', 'elena'],
    leadsTo: [
      {
        node: 'anchor',
        relation: 'became',
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      "The rule the entire universe runs on: nature permits no imbalance. Every immortality gets a cure. Every curse gets a loophole. Every shortcut generates a shadow. Doppelgängers, the cure, the Five, the white oak, the sireline rule — none of these are villains' inventions. They are corrections.",
    facts: [
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      'Qetsiyah made exactly one dose of a cure for immortality and entombed it with Silas. The cruelty is in the design: to escape starvation he would have to take it, become mortal, die — and land on the Other Side with her, forever, instead of finding peace with Amara.',
    facts: [
    ...
    peopleInvolved: ['qetsiyah', 'silas', 'katherine', 'elena', 'stefan', 'damon', 'kai'],
    leadsTo: [
      {
        node: 'silas',
  ...
  },
  {
    ...
    category: 'death',
    summary:
      "Qetsiyah's purgatory: a mirror of the living world where every supernatural being goes when it dies — able to see everything, touch nothing, and wait. It was built to trap one man. Everybody else who died supernatural for two thousand years was collateral damage.",
    facts: [
    ...
    peopleInvolved: ['qetsiyah', 'amara', 'bonnie', 'silas'],
    leadsTo: [
      {
        node: 'anchor',
        relation: 'runs on',
  ...
  },
  {
    ...
    category: 'death',
    summary:
      "The Other Side's doorstop. Every supernatural death physically passes through the Anchor, who feels each one. Amara held it for two thousand years. Bonnie Bennett takes it in 2013, which is why she can suddenly see and touch the dead — and why traffic accumulates in her.",
    facts: [
    ...
    peopleInvolved: ['amara', 'bonnie', 'silas'],
    leadsTo: [
      {
        node: 'amara',
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      "Nature's response to two people cheating death: it keeps reprinting their faces. Silas and Amara each got a recurring mortal shadow, born again every few centuries. It matters because doppelgänger blood is the only fuel that will run an Original-tier spell.",
    facts: [
    ...
    peopleInvolved: ['amara', 'silas', 'tatia', 'katherine', 'elena', 'stefan', 'tomavery'],
    leadsTo: [
      {
        node: 'tatia',
        relation: 'produced',
  ...
  },
  {
    ...
    peopleInvolved: ['markos', 'silas', 'qetsiyah'],
    leadsTo: [
      {
        node: 'markos',
        relation: 'led by',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      "A witch and a warrior from the Old World. They lost a child to plague, and Esther's friend Ayana told them of a land across the sea where the people were healthy and strong. They took what family they had left and went. Esther is the most consequential person in the franchise and one of its worst mothers.",
    facts: [
    ...
    peopleInvolved: ['esther', 'mikael', 'ayana', 'dahlia'],
    leadsTo: [
      {
        node: 'dahlia',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      'Esther was barren. Her elder sister Dahlia — far stronger and considerably worse — made her fertile, in exchange for the firstborn of every generation of their bloodline, forever. Esther paid once, with Freya, and spent the next thousand years hiding everyone else.',
    facts: [
    ...
    peopleInvolved: ['dahlia', 'esther', 'freya', 'hope'],
    leadsTo: [
      {
        node: 'freya',
        relation: 'collected',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "The Mikaelsons' true firstborn, handed to Dahlia as payment and reported dead of plague. Raised as Dahlia's weapon, held in the same cycle of a century's sleep for each year awake, and returned to the story a thousand years later as the only Mikaelson who is still a witch — and the only one who can plan.",
    facts: [
    ...
    peopleInvolved: ['freya', 'dahlia', 'esther', 'keelin', 'hope'],
    leadsTo: [
      {
        node: 'dahliareturn',
        relation: 'killed',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      'They settled in what would eventually be Mystic Falls, Virginia, beside a community of people who became wolves at the full moon. For years the arrangement held perfectly well: the wolves changed, everyone else stayed indoors, and in the morning it was over.',
    facts: [
    ...
    peopleInvolved: ['esther', 'mikael', 'ayana', 'henrik', 'klaus'],
    leadsTo: [
      {
        node: 'wolves',
        relation: 'neighbours',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      "Werewolves are the older species. They existed long before Esther's spell, turning involuntarily and agonisingly on the full moon, and they are the reason the Mikaelsons hid one night a month. Vampires were, from day one, built partly as a defence against them.",
    facts: [
    ...
    peopleInvolved: ['ansel', 'tyler', 'mason', 'jules', 'hayley', 'klaus'],
    leadsTo: [
      {
        node: 'ansel',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      "Esther had an affair with a man from the wolf village. Niklaus is his son, and neither of them knew it until Klaus's first kill woke his wolf side. Mikael's response was to kill Ansel, his family and half the village's wolves in a night — and to spend the next thousand years reminding Klaus what he was.",
    facts: [
    ...
    peopleInvolved: ['ansel', 'esther', 'klaus', 'mikael'],
    leadsTo: [
      {
        node: 'hybridcurse',
        relation: 'caused',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      "The youngest Mikaelson. Klaus sneaked him out to watch the wolves change and one of them tore him apart. Esther, refusing to bury another child, went looking for a spell that would make the rest of them impossible to kill. Everything in eleven seasons of television descends from one boy's curiosity and one brother's bad judgement.",
    facts: [
    ...
    peopleInvolved: ['henrik', 'klaus', 'esther', 'rebekah'],
    leadsTo: [
      {
        node: 'spell',
        relation: 'caused',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      "A woman of the village whom both Elijah and Klaus loved, and the first Petrova doppelgänger — Amara's shadow, arriving exactly when the story needed her. Esther killed her, put her blood in the wine for the immortality spell, and used it again to bind Klaus's wolf.",
    facts: [
    ...
    peopleInvolved: ['tatia', 'elijah', 'klaus', 'esther', 'amara'],
    leadsTo: [
      {
        node: 'doppel',
        relation: 'first of',
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      'An ancient white oak at the centre of the village, whose life force Esther drew on for the spell. Because nature charges for everything, the same tree is the only thing in existence that can permanently kill what she made. The family burned it immediately. Wood from it kept turning up anyway.',
    facts: [
    ...
    peopleInvolved: ['mikael', 'klaus', 'rebekah', 'damon', 'elena', 'esther'],
    leadsTo: [
      {
        node: 'spell',
        relation: 'fuelled',
  ...
  },
  {
    ...
    peopleInvolved: ['mikael', 'esther', 'finn', 'elijah', 'klaus', 'kol', 'rebekah'],
    leadsTo: [
      {
        node: 'sirelines',
        relation: 'source of',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      'The counterweights that arrived with vampirism: burning in sunlight, no entry to a home without an invitation, vervain, wood through the heart, and every emotion amplified into something close to unbearable. Witches patched the first with daylight rings. Nothing patches the last.',
    facts: [
    ...
    peopleInvolved: ['stefan', 'damon', 'caroline', 'elena', 'lexi'],
    leadsTo: [
      {
        node: 'originals',
        relation: 'binds',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      "When Klaus's first kill triggered his wolf, Esther bound it — using Tatia's blood and the moonstone — so he could never be both. She did it to keep Mikael from killing him. Klaus spent a thousand years working to undo it, and the first two seasons of The Vampire Diaries are really about nothing else.",
    facts: [
    ...
    peopleInvolved: ['klaus', 'esther', 'tatia', 'elena', 'jules', 'jenna', 'greta'],
    leadsTo: [
      {
        node: 'sunmoon',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      "Every vampire alive descends from one Original. Kill that Original with white oak and the entire line dies with them. Klaus's line is by far the largest, which makes him functionally unkillable — killing him would wipe out most vampires on Earth, including nearly everyone the audience likes.",
    facts: [
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      "Esther made her husband a vampire too, and he became the thing that hunts them. Mikael fed on vampires rather than people, chased his own children across nine centuries and three continents, and killed Klaus's wolf father, Klaus's hybrids, and eventually — briefly — Klaus.",
    facts: [
    ...
    peopleInvolved: ['mikael', 'klaus', 'esther', 'rebekah', 'stefan'],
    leadsTo: [
      {
        node: 'nola1919',
  ...
  },
  {
    ...
    peopleInvolved: ['qetsiyah', 'connor', 'jeremy', 'alexander', 'vaughn', 'shane', 'silas'],
    leadsTo: [
      {
        node: 'cure',
        relation: 'maps to',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      "The first three people the Mikaelsons ever turned: Lucien, a servant in the de Martel household; the nobleman Tristan de Martel; and Tristan's sister Aurora, whom Klaus loved and Rebekah turned against his wishes. Nine hundred years later all three come back at once, and the sireline structure they represent becomes the spine of the whole conflict.",
    facts: [
    ...
    peopleInvolved: ['lucien', 'tristan', 'aurora', 'klaus', 'elijah', 'rebekah'],
    leadsTo: [
      {
        node: 'sirelines',
        relation: 'embody',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      'A lie, and a very good one. Klaus fabricated an ancient curse binding vampires to the night and werewolves to the moon, and seeded it into Aztec and Viking legend so both species would spend centuries hunting the moonstone and the doppelgänger on his behalf. There is no such curse. There is only his.',
    facts: [
    ...
    peopleInvolved: ['klaus', 'elijah', 'elena', 'katherine', 'mason'],
    leadsTo: [
      {
        node: 'hybridcurse',
        relation: 'covers for',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      "Packs carried the gene down the centuries: the Crescents and the Malraux around New Orleans, the Lockwoods in Mystic Falls. A wolf who has never killed does not know what they are, which means every werewolf's origin story is also a manslaughter.",
    facts: [
    ...
    peopleInvolved: ['tyler', 'mason', 'jules', 'hayley', 'jackson', 'carol'],
    leadsTo: [
      {
        node: 'crescent',
        relation: 'cursed as',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      'The witch who led the Mikaelsons across the sea and then refused to help Esther cast, calling the spell an abomination against nature. She was right. Her descendants spend the next thousand years cleaning up after it.',
    facts: [
    ...
    peopleInvolved: ['ayana', 'esther', 'emily', 'bonnie', 'sheila'],
    leadsTo: [
      {
        node: 'bennett',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      'Ayana, Emily, Sheila "Grams", her daughter Abby, Lucy, and Bonnie. The most powerful and most routinely sacrificed family in the franchise. Almost every spell that holds the world together across eleven seasons is either cast by a Bennett or paid for with a Bennett\'s life.',
    facts: [
    ...
    peopleInvolved: ['ayana', 'emily', 'sheila', 'abby', 'lucy', 'bonnie', 'rudy'],
    leadsTo: [
      {
        node: 'emily',
        relation: 'includes',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      'A Bulgarian girl disgraced by a pregnancy, exiled by her father, and then hunted across Europe by Klaus as the doppelgänger he needed. She turned herself into a vampire specifically to be useless to him — the sacrifice requires a human — and then ran for five hundred years without ever once being caught.',
    facts: [
    ...
    peopleInvolved: ['katherine', 'klaus', 'elijah', 'trevor', 'rose', 'nadia', 'stefan', 'damon'],
    leadsTo: [
      {
        node: 'doppel',
        relation: 'second of',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      'Klaus, Elijah and Rebekah arrived in a young colonial port and effectively built it. For two hundred years the Mikaelsons were New Orleans — its power, its rules, its brutality, and the one truce that ever held between vampires, witches and wolves.',
    facts: [
    ...
    peopleInvolved: ['klaus', 'elijah', 'rebekah', 'marcel', 'kieran'],
    leadsTo: [
      {
        node: 'marcel',
        relation: 'raised',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      'Born to an enslaved woman and the man who owned her, taken in by Klaus as a boy and named Marcellus — "the little warrior." Klaus raised him, Rebekah loved him, and in 1919 Klaus abandoned him believing him dead. Marcel took the city instead and held it for a hundred years.',
    facts: [
    ...
    peopleInvolved: ['marcel', 'klaus', 'rebekah', 'davina', 'josh', 'elijah'],
    leadsTo: [
      {
        node: 'nola1919',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      'Mikael tracked his children to New Orleans and burned the opera house down around them. Klaus ran, Rebekah was daggered for calling her father there, Marcel was left for dead, and the family did not return for ninety years.',
    facts: [
    ...
    peopleInvolved: ['mikael', 'klaus', 'rebekah', 'marcel', 'stefan'],
    leadsTo: [
      {
        node: 'marcel',
        relation: 'abandoned',
  ...
  },
  {
    ...
    peopleInvolved: ['hayley', 'jackson', 'celeste', 'klaus', 'marcel'],
    leadsTo: [
      {
        node: 'hayley',
        relation: 'trapped',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      "Mystic Falls' founding families — Salvatore, Gilbert, Fell, Forbes, Lockwood — organised as a vampire-hunting council, dosed the town's drinks with vervain, and rounded up twenty-seven vampires to burn in a church. Their descendants inherit the Council, the ledger, and a truly world-class capacity for denial.",
    facts: [
    ...
    peopleInvolved: ['giuseppe', 'johngilbert', 'liz', 'carol', 'emily', 'jeremy', 'elena'],
    leadsTo: [
      {
        node: 'salvatore',
        relation: 'made',
  ...
  },
  {
    ...
    peopleInvolved: ['stefan', 'damon', 'giuseppe', 'katherine', 'emily', 'zach'],
    leadsTo: [
      {
        node: 'ripper',
        relation: 'made',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "Katherine's handmaiden and a Bennett witch. She faked Katherine's death in the church fire and sealed the other twenty-six vampires beneath it — not killed, just desiccating for 145 years, held under a spell keyed to a comet. It is the errand that brings Damon home in 2009.",
    facts: [
    ...
    peopleInvolved: ['emily', 'katherine', 'bonnie', 'damon', 'sheila'],
    leadsTo: [
      {
        node: 'bennett',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      "Stefan and Damon's mother, officially dead of consumption in 1858. In fact a vampire, and a ripper, shipped off to Europe — and eventually sealed by the Gemini coven into a 1903 prison world with the family she preferred: six siphoner witches she had turned into vampires herself.",
    facts: [
    ...
    peopleInvolved: ['lily', 'stefan', 'damon', 'valerie', 'julian', 'kai'],
    leadsTo: [
      {
        node: 'heretics',
        relation: 'made',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      'A coven built around one horrifying tradition. Every generation produces a set of twins; at a set age they merge, and the stronger absorbs the weaker, who dies. The survivor leads the coven. They also build prison worlds — perfect looping repeats of a single day — and use them as cells.',
    facts: [
    ...
    peopleInvolved: ['joshuaparker', 'kai', 'jo', 'luke', 'liv', 'josie', 'lizzie'],
    leadsTo: [
      {
        node: 'prisonworld',
        relation: 'built',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      "A secret research society at Whitmore College that captured vampires and vivisected them for decades in the name of science. Damon was subject 21051 in 1953. Enzo was there for seventy years. It is the franchise's plainest statement of its own thesis: humans are not the safe species.",
    facts: [
    ...
    peopleInvolved: ['damon', 'enzo', 'meredith'],
    leadsTo: [
      {
        node: 'armory',
        relation: 'feeds into',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      "Stefan's condition. Human blood turns him into a compulsive, escalating killer who dismembers his victims and then, in remorse, reassembles them. It recurs across the entire series, and it is why he treats his own humanity switch like a loaded weapon he is holding for someone else.",
    facts: [
    ...
    peopleInvolved: ['stefan', 'lily', 'klaus', 'lexi', 'elena'],
    leadsTo: [
      {
        node: 'salvatore',
        relation: 'began at',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "Siphoners turned into vampires: Valerie, Oscar, Nora, Mary Louise, Beau and Malcolm — Lily's found family. A siphoner vampire is a magic-using vampire, the exact combination the Gemini built prison worlds to prevent, because a vampire is an endless magical battery to siphon from.",
    facts: [
    ...
    peopleInvolved: ['valerie', 'nora', 'marylouise', 'beau', 'malcolm', 'lily', 'julian'],
    leadsTo: [
      {
        node: 'gemini',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      'Gemini cells: one day, repeating forever, alone. Malachai "Kai" Parker — a siphoner and a genuine sociopath who murdered four of his siblings at twenty-two — spent 1994 in one, until Bonnie and Damon landed there and he came back out with them. He is the most effective villain the franchise produced.',
    facts: [
    ...
    peopleInvolved: ['kai', 'bonnie', 'damon', 'jo', 'luke', 'liv', 'josie', 'lizzie', 'elena'],
    leadsTo: [
      {
        node: 'gemini',
        relation: 'built by',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      'A secret society and vault run by the St. John family, holding centuries of supernatural artefacts — and one very old thing sealed in the basement that nobody should have gone looking for. Alaric ends up running the library, which is how the Salvatore School later acquires a research collection.',
    facts: [
    ...
    peopleInvolved: ['alaric', 'enzo', 'bonnie', 'sybil', 'seline'],
    leadsTo: [
      {
        node: 'sirens',
        relation: 'held',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      'A huntress with eight lives, bound to a sword that brands vampires and a stone that traps their souls in bespoke personal hells. Her mark makes every other vampire on Earth compulsively hunt whoever carries it — an elegant way to make one person the problem of an entire species.',
    facts: [
    ...
    peopleInvolved: ['rayna', 'stefan', 'damon', 'bonnie', 'enzo'],
    leadsTo: [
      {
        node: 'cade',
  ...
  },
  {
    ...
    category: 'death',
    summary:
      "A psychic burned at the stake in the second century who refused to stop existing. His consciousness became a dimension that consumes the souls of the guilty. Once the Other Side collapses, Cade's Hell is where dead supernaturals go. He is, functionally, the Devil, and he keeps a ledger.",
    facts: [
    ...
    peopleInvolved: ['cade', 'sybil', 'seline', 'stefan', 'damon', 'bonnie', 'katherine'],
    leadsTo: [
      {
        node: 'sirens',
        relation: 'serve',
  ...
  },
  {
    ...
    peopleInvolved: ['sybil', 'seline', 'cade', 'damon', 'stefan', 'josie', 'lizzie'],
    leadsTo: [
      {
        node: 'cade',
        relation: 'serve',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      "Stefan comes back to Mystic Falls because a girl there has Katherine's face. Damon comes back to open the tomb and get Katherine out. Neither errand survives contact with reality, and the two of them stay for eight years.",
    facts: [
    ...
    peopleInvolved: ['stefan', 'damon', 'elena', 'zach', 'caroline', 'bonnie', 'alaric'],
    leadsTo: [
      {
        node: 'elena',
        relation: 'meets',
  ...
  },
  {
    ...
    peopleInvolved: ['katherine', 'nadia', 'elena', 'stefan', 'damon', 'cade'],
    leadsTo: [
      {
        node: 'katherine',
        relation: 'is',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      'A thousand years of searching ends when the Originals learn a Petrova doppelgänger is alive in Virginia. Klaus arrives, and the series stops being about two brothers and a girl and starts being about a family older than most nations.',
    facts: [
    ...
    peopleInvolved: ['klaus', 'elijah', 'rebekah', 'kol', 'finn', 'stefan', 'caroline', 'tyler'],
    leadsTo: [
      {
        node: 'originals',
        relation: 'brings',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      "Klaus's ritual: drain a werewolf, a vampire and the doppelgänger on a full moon with the moonstone. He uses Jules, Jenna Sommers — turned specifically for the purpose — and Elena. It works. He becomes the Original hybrid. Then he discovers he cannot make more, because the doppelgänger did not stay dead.",
    facts: [
    ...
    peopleInvolved: ['klaus', 'elena', 'jenna', 'jules', 'greta', 'bonnie', 'johngilbert', 'damon'],
    leadsTo: [
      {
        node: 'hybridcurse',
        relation: 'breaks',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "The last Bennett. Across eight seasons she dies, becomes the Anchor, becomes the Other Side's load-bearing wall, loses her magic to the Travelers, gets stranded in 1994, has her lifespan tied to Elena's coma, and repeatedly hands over her own life so that other people's plots can proceed. By workload she is the protagonist.",
    facts: [
    ...
    peopleInvolved: ['bonnie', 'sheila', 'abby', 'elena', 'damon', 'enzo', 'jeremy', 'kai'],
    leadsTo: [
      {
        node: 'bennett',
        relation: 'last of',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      'White oak, at last. Finn dies in 2012 and takes a whole sireline with him — which is how everybody learns the rule. From that point the entire cast is one stake away from mass extinction, and the question of who sired whose line stops being trivia and becomes a survival problem.',
    facts: [
    ...
    peopleInvolved: ['finn', 'kol', 'klaus', 'elijah', 'rebekah', 'jeremy', 'alaric', 'esther'],
    leadsTo: [
      {
        node: 'whiteoak',
        relation: 'uses',
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      "The hunter's map, Professor Shane, an island with a tomb under it, and the slow realisation that the cure comes attached to a two-thousand-year-old immortal who has been feeding Bonnie instructions in the shape of her dead grandmother. Katherine takes the cure. Silas gets loose.",
    facts: [
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      "Desiccated for two thousand years, Silas walks out wearing Stefan's face — because Stefan is his doppelgänger — and starts dismantling the Other Side so he can die and be with Amara. Qetsiyah, calling herself Tessa, comes back to stop him. Both are dead within the year, and the damage they do is permanent.",
    facts: [
    ...
    peopleInvolved: ['silas', 'qetsiyah', 'amara', 'stefan', 'bonnie', 'damon'],
    leadsTo: [
      {
        node: 'silas',
        relation: 'is',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "The Travelers finally get both living doppelgängers into one place and cast. It breaks the curse on them and simultaneously unmakes every other form of magic inside the town's borders — which is why Mystic Falls spends a season as a place where witches cannot cast and vampires cannot heal.",
    facts: [
    ...
    peopleInvolved: ['markos', 'stefan', 'elena', 'bonnie', 'caroline', 'liz', 'tyler'],
    leadsTo: [
      {
        node: 'travelers',
        relation: 'led',
  ...
  },
  {
    ...
    category: 'death',
    summary:
      'Two thousand years of accumulated damage — Silas, Qetsiyah, the Travelers, and one exhausted Bennett holding it up — and the purgatory disintegrates. A handful of the dead push back through into life. Most are simply unmade. Damon and Bonnie land in a prison world instead of nowhere.',
    facts: [
    ...
    peopleInvolved: ['bonnie', 'damon', 'silas', 'qetsiyah', 'markos', 'lexi', 'alaric', 'enzo'],
    leadsTo: [
      {
        node: 'otherside',
        relation: 'destroys',
  ...
  },
  {
    ...
    category: 'vamp',
    summary:
      "Lily's siphoner-vampire family takes Mystic Falls, drives the population out and forces the whole cast into a three-year time jump. The town is literally evacuated. It is the strangest structural decision the show ever makes and it works better than it has any right to.",
    facts: [
  ...
  },
  {
    ...
    category: 'origin',
    summary:
      "Elena takes the cure and is human again — and then Kai's linking spell ties her life to Bonnie's: Elena sleeps until Bonnie dies. It costs the show its lead for two seasons, and costs Damon a wait he ultimately does not have to finish.",
    facts: [
    ...
    peopleInvolved: ['elena', 'bonnie', 'damon', 'kai', 'stefan'],
    leadsTo: [
      {
        node: 'cure',
        relation: 'uses',
  ...
  },
  {
    ...
    peopleInvolved: ['cade', 'katherine', 'stefan', 'damon', 'bonnie', 'matt', 'elena', 'caroline'],
    leadsTo: [
      {
        node: 'cade',
        relation: 'destroys',
  ...
  },
  {
    ...
    category: 'death',
    summary:
      'Hell is gone and the Other Side has been gone for years, so the dead simply find peace. Bonnie breaks the spell and Elena wakes. She and Damon grow old and die of nothing in particular. Stefan and Lexi are waiting. The Salvatore house becomes a school.',
    facts: [
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      'A werewolf with no idea where she came from, who spends one night with Klaus in the Blue Ridge Mountains and turns up pregnant — which should be impossible, because vampires cannot procreate. It is possible because Klaus was born a werewolf and, technically, is not a vampire the way anyone else is.',
    facts: [
    ...
    peopleInvolved: ['hayley', 'klaus', 'elijah', 'hope', 'jackson', 'marcel'],
    leadsTo: [
      {
        node: 'hope',
        relation: 'mother of',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      "Born to a werewolf and the Original hybrid: witch by Esther's blood, wolf by Ansel's, vampire by Esther's spell. The first tribrid. Every faction in New Orleans wants her dead or owned before she can walk, and a thousand-year-old bargain has her name on it in advance.",
    facts: [
  ...
  },
  {
    ...
    category: 'house',
    summary:
      "Three powers, one city. Marcel's vampires hold the streets. Nine covens of witches hold the ancestral magic and the cemeteries. The wolves are shut out of both. Klaus comes home in 2011 to take it back, and the next five years are that fight, restarted every season with different weapons.",
    facts: [
    ...
    peopleInvolved: ['klaus', 'marcel', 'davina', 'vincent', 'sophie', 'josh', 'cami', 'kieran'],
    leadsTo: [
      {
        node: 'ancestors',
        relation: 'powered by',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "New Orleans witches do not draw on nature or on spirits generally. They draw on their own dead, buried in the city's cemeteries — and the dead have opinions, demands, and the ability to withdraw everything. It gives the covens enormous power and makes them hostage to a committee of ghosts.",
    facts: [
    ...
    peopleInvolved: ['davina', 'vincent', 'sophie', 'monique', 'genevieve', 'celeste', 'inadu'],
    leadsTo: [
      {
        node: 'quarter',
        relation: 'holds',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "A thousand years late, Esther's sister arrives to collect the firstborn of the next generation: Hope. Freya — the first payment — comes back to help kill her. The family that spent a millennium tearing itself apart holds together for exactly one enemy, and only just.",
    facts: [
    ...
    peopleInvolved: ['dahlia', 'freya', 'esther', 'klaus', 'elijah', 'rebekah', 'hope', 'hayley'],
    leadsTo: [
      {
        node: 'dahlia',
        relation: 'is',
  ...
  },
  {
    ...
    peopleInvolved: ['inadu', 'hope', 'klaus', 'elijah', 'vincent', 'freya', 'davina'],
    leadsTo: [
      {
        node: 'ancestors',
        relation: 'hid in',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      'Klaus, Elijah, Rebekah and Kol each carry a quarter of the Hollow and can never be in the same room again. Hope grows up mostly without her father, writing him letters. Hayley is killed. The last season of The Originals is a family that finally learned how to be together being forbidden from it.',
    facts: [
    ...
    peopleInvolved: ['klaus', 'elijah', 'rebekah', 'kol', 'hope', 'hayley', 'marcel', 'freya'],
    leadsTo: [
      {
        node: 'hollowend',
        relation: 'ends in',
  ...
  },
  {
    ...
    peopleInvolved: ['klaus', 'elijah', 'hope', 'marcel', 'rebekah', 'freya', 'caroline'],
    leadsTo: [
      {
        node: 'hope',
        relation: 'saves',
  ...
  },
  {
    ...
    category: 'house',
    summary:
      'Rebekah takes the cure and a mortal life, with Marcel, and plans to grow old. Kol and Davina leave together. Freya marries Keelin. Hope inherits a fortune, a place at a school in Virginia, and a father she will spend four more seasons trying not to become.',
    facts: [
    ...
    peopleInvolved: ['freya', 'keelin', 'rebekah', 'marcel', 'kol', 'davina', 'hope', 'caroline'],
    leadsTo: [
      {
        node: 'school',
        relation: 'endows',
  ...
  },
  {
    ...
    category: 'witch',
    summary:
      "Alaric and Caroline's daughters. Conceived from Alaric and Jo's embryos, magically moved into Caroline when Jo was killed, and born Gemini twins — and siphoners, with no magic of their own, able only to draw it out of other magical things.",
    facts: [
    ...
    peopleInvolved: ['josie', 'lizzie', 'alaric', 'caroline', 'jo', 'kai', 'joshuaparker'],
    leadsTo: [
      {
        node: 'gemini',
        relation: 'of the',
  ...
  },
  {
    ...
    peopleInvolved: ['josie', 'lizzie', 'alaric', 'kai', 'jo', 'joshuaparker', 'luke', 'liv'],
    leadsTo: [
      {
        node: 'gemini',
        relation: 'set by',
  ...
  },
  {
    ...
    peopleInvolved: ['landon', 'clarke', 'hope', 'necromancer', 'ken'],
    leadsTo: [
      {
        node: 'landon',
        relation: 'father of',
  ...
  },
  {
    ...
    category: 'death',
    summary:
      "A foster kid with no idea what he is: Malivore's son, and a phoenix — he resurrects every time he dies, which is often. He is what the pit wants back, and he is the show's argument that being a monster is a job description rather than a nature.",
    facts: [
    ...
    peopleInvolved: ['landon', 'rafael', 'hope', 'clarke', 'mg'],
    leadsTo: [
      {
        node: 'malivore',
        relation: 'son of',
  ...
  },
  {
    ...
    category: 'wolf',
    summary:
      "Hope's vampire nature stays dormant until she dies with vampire blood in her system. When she finally activates it she is the first fully-realised tribrid — and because a tribrid's vampire half comes with a humanity switch, briefly the most dangerous thing that has ever existed. Malivore is destroyed. So, nearly, is everyone else.",
    facts: [
    ...
    peopleInvolved: ['hope', 'landon', 'alaric', 'josie', 'lizzie', 'cleo', 'mg'],
    leadsTo: [
      {
        node: 'hope',
        relation: 'is',
  ...
  },
  {
    ...
    peopleInvolved: ['ken', 'aurora', 'cleo', 'hope', 'lizzie', 'josie', 'necromancer'],
    leadsTo: [
      {
        node: 'lucien',
